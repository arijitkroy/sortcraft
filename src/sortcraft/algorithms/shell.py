...
def shell_sort_singly(ll: SinglyLinkedList[T]) -> None:
    """
    Shell sort (unstable, O(n log n) to O(n^2)), sorts singly linked list in-place (values only).
    ...
    Notes:
        - Time: O(n log n) worst (good gaps), else O(n^2).
        - Space: O(1).
        - Stable: No.

    Examples:
        >>> ll = SinglyLinkedList([5, 1, 3, 2, 9, 6])
        >>> shell_sort_singly(ll)
        >>> ll.to_list()
        [1, 2, 3, 5, 6, 9]
    """
    arr = ll.to_list()
...
def shell_sort_doubly(ll: DoublyLinkedList[T]) -> None:
    """
    Shell sort (unstable, O(n log n) to O(n^2)), sorts doubly linked list in-place (values only).
    ...
    Examples:
        >>> dl = DoublyLinkedList([5, 1, 3, 2, 9, 6])
        >>> shell_sort_doubly(dl)
        >>> dl.to_list()
        [1, 2, 3, 5, 6, 9]
    """
    arr = ll.to_list()
...
def shell_sort_circular(ll: CircularLinkedList[T]) -> None:
    """
    Shell sort (unstable, O(n log n) to O(n^2)), sorts circular linked list in-place (values only).
    ...
    Examples:
        >>> cl = CircularLinkedList([5, 1, 3, 2, 9, 6])
        >>> shell_sort_circular(cl)
        >>> cl.to_list()
        [1, 2, 3, 5, 6, 9]
    """
    arr = ll.to_list()
